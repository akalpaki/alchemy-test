...
// ErrorResponse is a helper function which returns an appropriate response to the user according to the status provided.
// ErrorResponse logs the underlying error for debugging purposes.
func ErrorResponse(
	logger *slog.Logger,
